...
/*******************************************属性域*******************************************************/
	...
	protected final int SizeFactor = 0;  //初代k0值：0.1  0.2  0.4  
...
/***************************构造函数域***********************************************************************/
	 ...
	 * @param measurance
	 */
	public DABC_Mutation(MachineSet mSet, JobSet jSet, CellSet cellSet,
	...
	public DABC_Mutation(MachineSet mSet, JobSet jSet, CellSet cellSet,
		...
		this.CurHeap    = new HeapMaxPriorityQueue<Chromosome>(populationSize*SizeFactor);
		this.ArchiveB   = new HeapMaxPriorityQueue<Chromosome>(populationSize*SizeFactor);
		this.Memory     = new HeapMaxPriorityQueue<Chromosome>(populationSize*SizeFactor);
	}
...
//		worstFunction=0;
	 ...
	 * @throws IOException 
	 */
	private void init_population() throws CloneNotSupportedException, IOException {                                   //单个解的初始
        int i;		
        int mSetSize = mSet.size();
		int vSetSize = cellSet.size();	              
...
//						        	strBuffer.delete(0, strBuffer.length());
			        		 ...
			        		 chromosome.setPartSequence(SourceIndex,TargetCell,RandomPriors_Intercell(temp));  
			        	}		
			        }			       			    			         
				}
			}
...
private int[] RandomPriors_Intercell(int[] source) { 
