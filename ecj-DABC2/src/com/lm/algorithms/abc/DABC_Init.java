...
/*******************************************属性域*******************************************************/
	...
	//算法参数
	protected int POPULATION_SIZE=4;                       //修改量POPULATION_SIZE
...
/***************************构造函数域***********************************************************************/
	 ...
	 * @param measurance
	 */
	public DABC_Init(MachineSet mSet, JobSet jSet, CellSet cellSet,
...
//		worstFunction=0;
	...
	private void init_population(int caseIndex) throws CloneNotSupportedException {                                   
		...
		for(i=0;i<POPULATION_SIZE;i++) {
			if(i<16){
				RulePrioirsReader(mSetSize,vSetSize,Constants.RULESET_DIR+"/" +caseIndex+"/"+(i+1));
