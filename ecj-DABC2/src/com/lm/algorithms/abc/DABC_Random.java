...
public class DABC_Random {


/*******************************************属性域*******************************************************/
	/**针对具体问题的调度过程**/
	protected MetaHeuristicScheduler_Notrans evaluator;
	/**适应度评估方法**/
	...
	protected int POPULATION_SIZE=24;                       //修改量POPULATION_SIZE
...
/***************************构造函数域***********************************************************************/
	 ...
	 * @param measurance
	 */
	public DABC_Random(MachineSet mSet, JobSet jSet, CellSet cellSet,
			MetaHeuristicScheduler_Notrans scheduler, MetaIMeasurance measurance) {
		this(mSet, jSet, cellSet, scheduler, measurance,100, 24);
	}
	 ...
	 */
	public DABC_Random(MachineSet mSet, JobSet jSet, CellSet cellSet,
			MetaHeuristicScheduler_Notrans scheduler, MetaIMeasurance measurance, int Maxcycle,
			int populationSize) {
		this.mSet = mSet;
		this.jSet = jSet;
...
/****************************方法域*********************************************************************/
	...
	public void schedule(int caseNo) throws CloneNotSupportedException, IOException {
		...
		this.bw = new BufferedWriter(new FileWriter(
				Constants.RANDOM_ITER_DIR+ "/"+ caseNo
				));	
