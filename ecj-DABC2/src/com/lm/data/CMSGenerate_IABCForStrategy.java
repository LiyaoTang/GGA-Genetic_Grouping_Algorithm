...
public class CMSGenerate_IABCForStrategy {
	public CMSGenerate_IABCForStrategy(int fileIndex) throws IOException {
		...
		try {
			...
			case 1:{
				...
				machNum =8;
				cellNum =3;
				int []Cell_Layout = {0, 1, 1,1,2,2, 2,3,3};
...
//			System.out.println("end for job"+jobNo);
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 0; i< Constants.TOTAL_PROBLEMS; i++) {
			CMSGenerate_IABCForStrategy dataSource = new CMSGenerate_IABCForStrategy(i);
