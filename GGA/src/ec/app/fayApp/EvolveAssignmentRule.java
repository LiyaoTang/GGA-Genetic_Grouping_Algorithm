...
public class EvolveAssignmentRule extends GPProblem implements
		SimpleProblemForm {
	...
	public double vehicleReturnTime;
	...
	public Object clone() {
		EvolveAssignmentRule newobj = (EvolveAssignmentRule) super.clone();
		...
		if (!ind.evaluated) {
			...
			for (int caseNo = 1; caseNo < Constants.TOTAL_PROBLEMS+1; caseNo ++) {
				...
				for (int ins = 0; ins < Constants.INSTANCES_PER_PROBLEM; ins++) {
					...
					SimpleScheduler.GPInfo.assiProblem = this;
