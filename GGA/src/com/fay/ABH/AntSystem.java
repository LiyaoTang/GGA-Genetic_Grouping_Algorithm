...
//				mchromosome.set(7,4);
			  // System.out.println("*************");
			  // System.out.println("curPopulationsize = " + mPopulation.size());
			  // System.out.println("defaultPopulationsize " + POPULATION_SIZE);
			//	System.out.println("*************");
				//for (Job job : jSet) {
				//	System.out.println(job.getNextScheduleOperation());
				//}
			//	System.out.println(mPopulation.size());
			//	System.out.println("*******");
...
//				bchromosome.set(2,6);
				...
				for (int index = 0; index < jobNum; index++) {
				 ...
				 evaluator = new SimpleScheduler(mSet,jSet,cellSet); ////!!!!!!!!!!!!!!!!!
