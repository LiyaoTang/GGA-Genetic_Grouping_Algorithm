	...
	public static void main(String[] args) throws IOException, CloneNotSupportedException {
		...
		try {
            ...
            for (int i = 1; i <= 12; i++) {
                ...
                CMSReader dr = new CMSReader("G:\\IntelliJ IDEA 2016.2\\Projects\\GGA - DABC\\CACO1\\" + i); // read from file and initialize machineSet, jobSet, cellSet, vehicleSet in CMSReader
